...
| **103** | Born rule as dynamical ATTRACTOR (Valentini relaxation, QNG-motivated): 15k trajectories started UNIFORM (≠\|ψ\|²) evolved by **phase-gradient flow v=∇S** (real QNG feature, CPU-045 ring drift), deterministic. Coarse-grained H-function **fell 1.012→0.042 (96%), monotone, toward sampling floor 0.0085** → \|ψ\|² is a quantum-equilibrium attractor. (First run with real mode-phases gave zero initial velocity → only 34%; fixed with random phases = genuine chaos.) Caveat: assumes v=∇S, not yet a v8 theorem | BORN_RULE_RELAXES_TO_PSI2_ATTRACTOR |
| **104** | guidance v=∇S **forced by unitarity** (not assumed): Madelung — Schrödinger (P102) ⟹ continuity ∂_tρ+∇·(ρ∇S/m)=0 ⟹ v=j/ρ=∇S/m **uniquely**. Equivariance demo: ensemble started AT \|ψ\|² stays (mean H=0.011 ≈ floor 0.009) → \|ψ\|² is a **fixed point**; with P103 (attractor) ⟹ Born rule dynamically selected (like Maxwell-Boltzmann). Single residual named: 'matter density = \|ψ\|²' (Gap 4) | GUIDANCE_FORCED_PSI2_FIXED_POINT_AND_ATTRACTOR |
