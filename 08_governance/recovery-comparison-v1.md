...
- N=32 transition mechanism (QNG-CPU-062): **PASS 3/4 — Tier-1.5 — MULTI-CAUSE TRANSITION**; P1 FAIL (1/5, v_sync monotone: 0.047→0.054→0.068→0.076); sync-speed-peak hypothesis FALSIFIED; P2 PASS (k̄ monotone: 3.20→4.33→6.92→13.03); P3 PASS (clustering non-monotone: minimum at N=32 then uptick: 0.3225→0.2538→0.2030→0.2051); P4 PASS (Pearson(v_sync,Δ_nohist)=0.662); **N=32 transition = multi-cause: clustering minimum + degree-distribution crossing + sync-speed correlation; no single-cause mechanism sufficient**
