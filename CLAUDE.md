...
`qng_multi_ring_reference` (QNG-CPU-046), `qng_ring_force_reference` (QNG-CPU-047), `qng_ring_force_linear_reference` (QNG-CPU-048)
...
Pre-registrations live in `07_validation/prereg/` (57 registered: GR-CPU-001, QM-CPU-001, QNG-CPU-001 through QNG-CPU-048, QNG-CPUGPU-001/002, QNG-GPU-001, QNG-OBS-001 through QNG-OBS-004).
