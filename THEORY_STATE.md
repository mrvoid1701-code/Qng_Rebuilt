...
| 20 | **Chirality (parity violation)** | **NEW open (2026-06-01, demo Phase 4c) — v14 wall** | 4c (demo-phase4c-fermion-doubling-v1): naive lattice Dirac → 16 doublers (Nielsen-Ninomiya); Wilson term decouples them but breaks chiral symmetry. Chiral weak sector needs a lattice-chiral solution (Ginsparg-Wilson/overlap/domain-wall) = v14. Same problem as lattice QCD; solved technology, major construction. |
